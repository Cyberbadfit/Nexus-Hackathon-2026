...
$("#create-team-form").onsubmit = async (e) => {
  ...
  try {
    const d = await API.createTeam({
      ...
      leaderCollege: $("#leader-institution").value.trim(),
      leaderRoll: $("#leader-roll").value.trim(),
      leaderCourse: $("#leader-course").value.trim(),
      leaderYear: $("#leader-year").value.trim(),
      leaderBranch: $("#leader-branch").value.trim(),
      leaderSection: $("#leader-section").value.trim(),
      leaderPhone: $("#leader-phone").value.trim(),
    });
...
$("#join-form").onsubmit = async (e) => {
  ...
  try {
    const d = await API.joinTeam({
      ...
      college: $("#member-institution").value.trim(),
      rollNo: $("#member-roll").value.trim(),
      phone: $("#member-phone").value.trim(),
      course: $("#member-course").value.trim(),
      year: $("#member-year").value.trim(),
      branch: $("#member-branch").value.trim(),
      section: $("#member-section").value.trim(),
    });
